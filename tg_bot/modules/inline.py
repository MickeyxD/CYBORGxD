...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on CYBORG",
            "description": "Look up a Telegram account in CYBORG database",
            "message_text": "Click the button below to look up a person in CYBORG database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about CYBORG",
            "message_text": "Click the button below to get to know about CYBORG.",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".about ",
        },
        {
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    CYBORG (@{context.bot.username})
    Maintained by [ʜʏᴘᴇʀ](t.me/ITS_KING_HYPER)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Support",
                    url=f"https://t.me/BIONIC_SUPPORT",
                ),
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/BIONIC_R0BOTS",
                ),
                InlineKeyboardButton(
                    text='Ping',
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About CYBORG (@{context.bot.username})",
