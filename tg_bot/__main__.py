                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/BIONIC_SUPPORT',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/BIONIC_R0BOTS",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "src_btn"),
                                url="https://github.com/HYPER-OP",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"CYBORG started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
        CYBORGINIT.bot_id = dispatcher.bot.id
        CYBORGINIT.bot_username = dispatcher.bot.username
        CYBORGINIT.bot_name = dispatcher.bot.first_name
...
if __name__ == "__main__":
    log.info("[CYBORG] Successfully loaded modules: " + str(ALL_MODULES))
